...
class TestVendorAdminEncryption:
    ...
    def test_encrypt_api_key_encrypts_data(self, mock_get_settings: MagicMock) -> None:
        ...
        mock_settings.vendor_encryption_key.get_secret_value.return_value = "test-secret-key-32-chars-long"
    ...
    def test_encrypt_api_key_encryption_error(self, mock_get_settings: MagicMock) -> None:
        ...
        mock_settings = MagicMock(spec=AppSettings)
        mock_settings.vendor_encryption_key.get_secret_value.side_effect = Exception("Encryption error")
        mock_get_settings.return_value = mock_settings
    ...
    async def test_insert_model_encrypts_api_key(self, mock_validate: AsyncMock, mock_encrypt: MagicMock) -> None:
    ...
    @patch("src.modules.admin.views.vendors.VendorAdminView._encrypt_api_key")
    @patch("src.modules.admin.views.vendors.VendorAdminView._validate")
    async def test_update_model_encrypts_api_key(self, mock_validate: AsyncMock, mock_encrypt: MagicMock) -> None:
